...
public final class AvroUtil {
	...
	public static Object toAvro(Object o, boolean bigDecimalFormatString) {
		if (o instanceof BigDecimal) {
			if (bigDecimalFormatString) {
				// Returns a string representation of this without an exponent
				// field.
			...
			long seconds = t.getTime() / MILLI_SECOND_CONV;
			long ns = seconds * NANO_CONV + t.getNanos();
			
			// Return nanoseconds (the accuracy of Timestamp)
			return ns;
	...
	/**
	 * Convert from Avro type to Sqoop's java representation of the SQL type see
	 * SqlManager#toJavaType
	 */
