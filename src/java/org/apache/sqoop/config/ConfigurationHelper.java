...
public final class ConfigurationHelper {
	...
	/**
	 * Set the (hinted) number of reduce tasks for a job.
	 */
	public static void setJobNumReduces(Job job, int numReduceTasks) {
		job.getConfiguration().setInt(
				ConfigurationConstants.PROP_MAPRED_REDUCE_TASKS, numReduceTasks);
	}
	...
	/**
	 * @return the number of mapper output records from a job using its
	 *         counters.
	 */
	...
	/**
	 * @return the Configuration property specifying WHERE conditions for the db
	 *         table.
	 */
	...
	/**
	 * Parse arguments in 'args' via the GenericOptionsParser and embed the
	 * results in the supplied configuration.
	 * 
	 * @param conf
	 *            the configuration to populate with generic options.
	 * @param args
